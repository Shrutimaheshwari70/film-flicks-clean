  ...
  return (
    <div className='w-[20%] h-full border-r-2 border-zinc-400 p-10'>
      ...
      <nav className='flex flex-col text-zinc-400 text-xl gap-3'>
        ...
        <Link to="/movie" className="hover:bg-[#DD4343] hover:text-white duration-300 rounded-lg p-5"><i className="mr-2 ri-movie-2-fill"></i>Movies</Link>

        <Link to='/tv' className="hover:bg-[#DD4343] hover:text-white duration-300 rounded-lg p-5"><i className="mr-2 ri-tv-2-fill"></i>Tv Shows</Link>
